                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                        <div class="card  box-shadow-0">
                            <div class="card-header">
                                <h4 class="card-title mb-1">Add Foods</h4>
                            </div>
                            <div class="card-body pt-0">
                                <form class="form-horizontal" method="POST" action="{{route('food.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="inputIngredients" placeholder="Ingredients" name="ingredients" value="{{old('ingredients')}}">
                                        <small>*separated by (,). Ex : Salt, Sugar, Etc</small>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="inputHouseNumber" placeholder="Food Price" name="price" value="{{old('price')}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="inputHouseNumber" placeholder="Food Rate" name="rate" value="{{old('rate')}}" step="0.01" max="5">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="inputType" placeholder="Type" name="types" value="{{old('types')}}">
