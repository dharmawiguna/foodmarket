...
<!-- Mirrored from php.spruko.com/nowa/nowa/pages/signup.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 14:40:43 GMT -->
											 ...
											 <form method="POST" action="{{ route('register') }}">
                                                @csrf
												 <div class="form-group">
													 <label>Name</label> <input class="form-control" placeholder="Enter your firstname and lastname" type="text" name="name">
												 </div>
												 <div class="form-group">
												 ...
												 <div class="form-group">
													 <label>Password Confirmation</label> <input class="form-control" placeholder="Enter your password" type="password" name="password_confirmation" >
												 </div>
												 <button class="btn btn-primary btn-block" role="button" type="submit">Create Account</button>
